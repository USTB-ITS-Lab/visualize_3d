import numpy as np
import glob, os, colorsys, random, sys
...
if __name__ == '__main__':
    ...
    for file_name in data_path:
        ...
        gt_labels = np.vstack((pred_data['gt']))
        pre_labels = np.vstack((pred_data['pre']))
        points = np.vstack((pred_data['x'], pred_data['y'], pred_data['z'])).T
        # plot ground truth
        Plot.semantic_ply(points, gt_labels)
        # plot validation
        # Plot.semantic_ply(points, pre_labels)
